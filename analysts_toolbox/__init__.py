...
db = SQLAlchemy()
celery = Celery(__name__, broker=c.CELERY_BROKER_URL, backend=c.CELERY_BROKER_URL)
...
def create_app():
    ...
    celery.conf["CELERY_ACCEPT_CONTENT"] = c.CELERY_ACCEPT_CONTENT
    celery.conf["CELERYD_TASK_SOFT_TIME_LIMIT"] = c.CELERYD_TASK_SOFT_TIME_LIMIT
